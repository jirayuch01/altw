        ...
        <div id="body_bg">
                                    ...
                                    <div class="col-md-12">
                                        <div class="error-404-page text-center">
                                            ...
                                            <form action="index.php">
                                                <button type="submit" class="btn btn-lg btn-danger">Home</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="footermenu" class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="index.php">Alternative Word Suggestion System
                                    <br>for English Writings Project</a>
                                </p>
                                <div class="clearfix"></div>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="container padding-vert-30">
                <div class="row">
                    <div id="copyright">
                        <p><b> &copy; 2017 </b>
                            <a href="http://www.phuket.psu.ac.th/index1.php" target="_blank">
